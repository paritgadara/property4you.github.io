...
class RealtynaHouzezProperty {
    ...
    private function updateProperty( $postId , $demo = true ){
        ...
        $arrayPost = array(
            ...
            'post_name'    => $this->getValue( 'post_name' ) ,
        ...
        if ( $this->mapValues( $slugValues ) !== false){
            ...
            if ( $this->propertyExists() ){
                ...
                if ( $this->isAllowedProperty() ){
                    ...
                    return ( $this->updateProperty( $this->getPropertyIdByIdxIdentity() , $demo ) !== false );
                ...
                return ( $this->insertProperty( $demo ) !== false );
